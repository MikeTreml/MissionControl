/**
 * Create Task form — pick project, enter title + description.
 *
 * Task ID is auto-generated by the store based on the project's prefix and
 * a fixed workflow letter (e.g. DA-017F). The legacy workflow-letter
 * picker has been removed; runtime workflow selection now happens via the
 * library workflow picker (see Library page → Run modal).
 */
