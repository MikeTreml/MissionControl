...
export async function process(inputs, ctx) {
  ...
  for (let attempt = 0; attempt < 3; attempt++) {
    ...
    const finalApproval = await ctx.breakpoint({ question: 'Review event reconstruction results', expert: 'owner', tags: ['approval-gate'], previousFeedback: lastFeedback || undefined, attempt: attempt > 0 ? attempt + 1 : undefined });
