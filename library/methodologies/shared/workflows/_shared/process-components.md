...
This folder is the stable import surface. The component implementations live in their closest subject buckets:

| Component | Implementation path |
|-----------|---------------------|
| `prior-attempts-scanner` | `business/knowledge-management/workflows/prior-attempts-scanner.js` |
| `completeness-gate` | `methodologies/process-hardening/workflows/completeness-gate.js` |
| `cost-aggregation` | `business/operations/workflows/cost-aggregation.js` |
| `tdd-triplet` | `methodologies/atdd-tdd/workflows/tdd-triplet.js` |
...
```js
import { createTddTriplet } from './index.js';
...
```js
import { executeTddTriplet } from './index.js';
...
```js
import { scanPriorAttempts, aggregateCosts, checkCompleteness } from './index.js';
...
All exports are available from `./index.js` (the preferred import path). Direct implementation paths are listed in the overview table.
