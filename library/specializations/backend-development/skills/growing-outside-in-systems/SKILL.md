...
Unlike inside-out TDD with mocks, this approach tests behavior at the boundary â€” not implementation details â€” making the suite refactor-friendly by design. See [references\methodology.md](references\methodology.md#why-outside-in-over-regular-tdd).
...
See [references\testing-strategy.md](references\testing-strategy.md) for full definitions, the testing matrix, and contract test patterns.
...
**The sequence is non-negotiable.** Each step collects evidence about what the adapter actually needs. See [references\methodology.md](references\methodology.md) for detailed rationale and the walking skeleton.
...
See [references\folder-structure.md](references\folder-structure.md) for full folder structure, private/public hexagon split, cross-hexagon dependency rule, adapter design patterns, and test seams.
...
Contract tests verify the real adapter matches the fake's behavior. See [references\testing-strategy.md](references\testing-strategy.md).

---

## Walking Skeleton

For new projects or major new components: build a minimal end-to-end implementation first to pay integration cost upfront. Once upright, pivot to the emergent design workflow. See [references\methodology.md](references\methodology.md).
...
- [references\glossary.md](references\glossary.md) â€” canonical terms
- [references\folder-structure.md](references\folder-structure.md) â€” folder structure, private/public hexagon, cross-hexagon rules, adapter patterns, test seams
- [references\testing-strategy.md](references\testing-strategy.md) â€” full testing matrix, acceptance/component test rules, contract test pattern
- [references\methodology.md](references\methodology.md) â€” why outside-in over regular TDD, walking skeleton, emergent design deep-dive, listen to the tests, anti-patterns
