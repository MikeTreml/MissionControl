...
- [x] workflows\specialization-creation.js - Create a new specialization with all 7 phases in sequence. Orchestrates the complete lifecycle from research to integration.
- [x] workflows\process-creation.js - Create a new process JS file from requirements. Includes task definition design, quality gate placement, and breakpoint strategy.
- [x] workflows\skill-creation.js - Create a new skill with harnesses\claude-code\examples\SKILL.md, README.md, and supporting files. Includes capability definition and tool permission specification.
- [x] workflows\agent-creation.js - Create a new agent with AGENT.md and README.md. Includes role definition, expertise specification, and prompt template design.
...
- [x] workflows\specialization-validator.js - Validate a specialization for completeness across all 7 phases. Score each phase and identify gaps.
- [ ] process-validator.js - Validate a process JS file for correct patterns, task definitions, and quality gates.
- [ ] skill-validator.js - Validate a skill for proper harnesses\claude-code\examples\SKILL.md format, tool permissions, and documentation.
...
- [ ] workflows\skill-creation.js - Create multiple skills in parallel from a backlog.
- [ ] workflows\agent-creation.js - Create multiple agents in parallel from a backlog.
...
1. workflows\specialization-creation.js
2. workflows\process-creation.js
3. workflows\skill-creation.js
4. workflows\agent-creation.js
...
12. workflows\specialization-validator.js
